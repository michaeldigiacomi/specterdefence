      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            Monitor mailbox forwarding rules and detect suspicious configurations
          </p>
        </div>
        <button
          onClick={fetchData}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{suspiciousCount}</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{maliciousCount}</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">External Fwd</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {externalForwardCount}
              </p>
            </div>
          </div>
        </div>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                      {alert.user_email} · {alert.description}
                    </p>
                  </div>
                  <span
                    className={clsx(
