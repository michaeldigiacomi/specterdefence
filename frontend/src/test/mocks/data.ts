...
export const mockDashboardData = {
  ...
  geo_heatmap: {
    locations: [
      { country_code: 'US', country_name: 'USA', latitude: 37.0902, longitude: -95.7129, login_count: 5000, user_count: 1200, risk_score_avg: 35.5 },
      { country_code: 'GB', country_name: 'UK', latitude: 55.3781, longitude: -3.436, login_count: 1200, user_count: 300, risk_score_avg: 42.0 },
      { country_code: 'DE', country_name: 'Germany', latitude: 51.1657, longitude: 10.4515, login_count: 800, user_count: 200, risk_score_avg: 38.5 },
    ],
    total_countries: 25,
    top_country: 'USA',
  },
  anomaly_trend: {
    data: [
      { date: '2024-01-01', count: 5, types: { impossible_travel: 3, new_country: 1, brute_force: 1 } },
  ...
  top_risk_users: {
    users: [
      { user_email: 'user1@contoso.com', tenant_id: 'tenant-1', risk_score: 85, anomaly_count: 12, top_anomaly_types: ['impossible_travel', 'new_country'], country_count: 5, last_anomaly_time: new Date().toISOString() },
      { user_email: 'admin@contoso.com', tenant_id: 'tenant-1', risk_score: 72, anomaly_count: 8, top_anomaly_types: ['brute_force'], country_count: 3, last_anomaly_time: new Date(Date.now() - 1000 * 60 * 60).toISOString() },
      { user_email: 'user2@fabrikam.com', tenant_id: 'tenant-2', risk_score: 65, anomaly_count: 5, top_anomaly_types: ['new_ip', 'impossible_travel'], country_count: 2, last_anomaly_time: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
    ],
    total_users: 150,
    avg_risk_score: 35.5,
  },
