...
class TestMSGraphClientHealthCheck:
    ...
    async def test_health_check_success(self, client, mock_msal_app):
        ...
        with patch("httpx.AsyncClient.get", new_callable=AsyncMock) as mock_get:
            # Mock organization endpoint (called by get_tenant_info)
            ...
            me_response.json.return_value = {"id": "test-user"}
            ...
            # Order matters: /organization, /me, /auditLogs/directoryAudits
            mock_get.side_effect = [org_response, me_response, audit_response]
    ...
    async def test_health_check_insufficient_permissions(self, client, mock_msal_app):
        ...
        with patch("httpx.AsyncClient.get", new_callable=AsyncMock) as mock_get:
            ...
            # Order: /organization, /me, /auditLogs/directoryAudits
            mock_get.side_effect = [org_response, me_response, audit_response]
...
class TestTenantServiceHealthCheck:
    ...
    async def test_health_check_tenant_not_found(self, mock_db):
        ...
        from src.services.tenant import TenantNotFoundError, TenantService
...
async def async_client_with_mock_db(mock_db):
    """Create async test client with mock database."""
...
class TestHealthCheckAPI:
    ...
    @pytest.mark.asyncio
    async def test_health_check_endpoint_success(self, async_client_with_mock_db, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_health_check_endpoint_not_found(self, async_client_with_mock_db, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_health_check_all_tenants(self, async_client_with_mock_db, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_health_check_with_custom_permissions(self, async_client_with_mock_db, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_health_check_with_custom_timeout(self, async_client_with_mock_db, mock_db):
