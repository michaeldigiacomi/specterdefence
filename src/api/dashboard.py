...
async def get_login_timeline(
    ...
    try:
        return await service.get_login_activity_timeline(
...
async def get_geo_heatmap(
    ...
    try:
        return await service.get_geo_heatmap_data(
            time_range=time_range,
            tenant_id=tenant_id
        )
    except Exception as e:
...
async def get_anomaly_trend(
    ...
    try:
        return await service.get_anomaly_trend(
            time_range=time_range,
            tenant_id=tenant_id
        )
    except Exception as e:
...
async def get_top_risk_users(
    ...
    try:
        return await service.get_top_risk_users(
            limit=limit,
            tenant_id=tenant_id
        )
    except Exception as e:
...
async def get_alert_volume(
    ...
    try:
        return await service.get_alert_volume(
            time_range=time_range,
            tenant_id=tenant_id
        )
    except Exception as e:
...
async def get_full_dashboard(
    ...
    try:
        ...
        geo_heatmap = await service.get_geo_heatmap_data(
            time_range=time_range, tenant_id=tenant_id
        )
        anomaly_trend = await service.get_anomaly_trend(
            time_range=time_range, tenant_id=tenant_id
        )
        top_risk_users = await service.get_top_risk_users(
            limit=10, tenant_id=tenant_id
        )
        alert_volume = await service.get_alert_volume(
            time_range=time_range, tenant_id=tenant_id
        )
