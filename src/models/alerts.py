...
class AlertWebhookModel(Base):
    ...
    webhook_type: Mapped[WebhookType] = mapped_column(
        SQLEnum(WebhookType, native_enum=False, values_callable=lambda x: [e.value for e in x]),
        nullable=False,
...
class AlertRuleModel(Base):
    ...
    min_severity: Mapped[SeverityLevel] = mapped_column(
        SQLEnum(SeverityLevel, native_enum=False, values_callable=lambda x: [e.value for e in x]),
        nullable=False,
