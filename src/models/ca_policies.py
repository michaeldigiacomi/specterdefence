...
class CAPolicyModel(Base):
    ...
    applies_to_all_users: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        comment="Whether policy applies to all users"
    )
    applies_to_all_apps: Mapped[bool] = mapped_column(
        Boolean,
        default=False,
        nullable=False,
        comment="Whether policy applies to all applications"
    )
    ...
    requires_compliant_device: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        comment="Whether policy requires compliant device"
    )
    ...
    is_mfa_required: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        comment="Whether MFA is required by this policy"
    )
    ...
    created_at: Mapped[datetime] = mapped_column(
        ...
        default=utc_now,
        nullable=False,
        comment="When policy was first detected"
    )
...
class CAPolicyChangeModel(Base):
    ...
    mfa_removed: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        comment="Whether MFA requirement was removed"
    )
    broadened_scope: Mapped[bool] = mapped_column(
        Boolean,
        default=False,
        nullable=False,
        comment="Whether policy scope was broadened"
    )
...
class CAPolicyAlertModel(Base):
    ...
    severity: Mapped[AlertSeverity] = mapped_column(
        SQLEnum(AlertSeverity, name="ca_alert_severity_enum"),
        nullable=False
    )
