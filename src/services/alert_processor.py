...
class AlertProcessor:
    ...
    async def process_login_analytics(
        ...
        user_history: Optional[UserLoginHistoryModel] = None,
    ) -> List[Dict[str, Any]]:
    ...
    def _map_anomaly_to_event_type(self, anomaly_flag: str) -> Optional[EventType]:
    ...
    def _build_metadata(
        self,
        login_data: LoginAnalyticsModel,
        user_history: Optional[UserLoginHistoryModel],
    ) -> Dict[str, Any]:
